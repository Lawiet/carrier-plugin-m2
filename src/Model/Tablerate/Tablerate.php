...
namespace Klikealo\Carrier\Model\Tablerate;
    ...
    \Magento\Shipping\Model\Carrier\CarrierInterface
{
    ...
    public function __construct(
        ...
        \Klikealo\Carrier\Model\ResourceModel\Tablerate\CollectionFactory $tablerateFactory,
        array $data = []
    ) {
