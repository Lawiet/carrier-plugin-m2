...
class RateQuery
{
    ...
    public function prepareSelect(\Magento\Framework\DB\Select $select)
    {
        $select->where(
            ...
            array('kctr' => 'klk_carrier_tablerate'),
            'klk_tablerate.tablerate_id = kctr.tablerate_id',
            array(

            )
        )->join(
            array('kc' => 'klk_carrier'),
            'kc.carrier_id = kctr.carrier_id',
            array(
                'carrier_code' => 'kc.code'
            )
        );
        ...
        $select->where("kc.code = :carrier_code");
    ...
    public function getBindings()
    {
        $bind = [
            ...
            ':carrier_code' => $this->request->carrierCode
        ];
